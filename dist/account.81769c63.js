...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/account/account.mappers.js":[function(require,module,exports) {
"use strict";
...
var url = "".concat("http://localhost:3000/api", "/account"); // para insertar una nueva cuenta
...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/account/account.js":[function(require,module,exports) {
"use strict";
...
var _account2 = require("./account.mappers");
...
if (isEditMode) {
  ...
  (0, _account3.getAccount)(params.id).then(function (apiAccount) {
    //me traigo los datos de la cuenta
    account = (0, _account2.mapAccountFromApiToViewModel)(apiAccount); //y se los meto con el mapeador

    (0, _helpers.onSetValues)(account); //viene de common/helpers para meter los valores en html
  });
}
...
(0, _helpers.onUpdateField)('type', function (event) {
  //cogemos el input type de html y en el evento(change)
  var value = event.target.value; //meto el valor en una variable

  account = _objectSpread(_objectSpread({}, account), {}, {
    //y cojo todo el array
...
(0, _helpers.onUpdateField)('alias', function (event) {
  //cogemos el input alias de html y en el evento(change)
  var value = event.target.value; //meto el valor en una variable
  ...
  _account.formValidation.validateForm(account).then(function (result) {
    ...
    if (result.succeeded) {
      onSave().then(function (apiAccount) {
        _router.history.back(); //console.log({apiAccount});
...
},{"../../common/helpers":"common/helpers/index.js","./account.validations":"pages/account/account.validations.js","./account.mappers":"pages/account/account.mappers.js","./account.api":"pages/account/account.api.js","../../core/router":"core/router/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
