...
exports.getMovementList = exports.getAccountDetails = void 0;

var _axios = _interopRequireDefault(require("axios"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var url = "".concat("http://localhost:3000/api", "/movements"); //la variable de entorno está .env

var urlAcccount = "".concat("http://localhost:3000/api", "/account-list");

var getMovementList = function getMovementList(id) {
...
var getAccountDetails = function getAccountDetails(id) {
  return _axios.default.get("".concat(urlAcccount, "/").concat(id)).then(function (response) {
    return response.data;
  });
};
...
exports.mapMovementListFromApiToViewModel = exports.mapAccountFromApiToViewModel = void 0;

var mapMovementFromApiToViewModel = function mapMovementFromApiToViewModel(movement) {
  //cambiar los datos de una formato a otro
  return {
    id: movement.id,
...
var mapMovementListFromApiToViewModel = function mapMovementListFromApiToViewModel(movementList) {
  //aquí hacemos un map para pasar por cada uno que nos devuelve otro array
...
if (isEditMode) {
  ...
  (0, _movements.getMovementList)(params.id).then(function (apiMovement) {
    //me traigo los datos de la cuenta por id
    movements = (0, _movements2.mapMovementListFromApiToViewModel)(apiMovement);
    (0, _movements3.addMovementRows)(movements);
  });
  (0, _movements.getAccountDetails)(params.id).then(function (apiAccount) {
    //me traigo los datos de la cuenta por id
    account = (0, _movements2.mapAccountFromApiToViewModel)(apiAccount);
