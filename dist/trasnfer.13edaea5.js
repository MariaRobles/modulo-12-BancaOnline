...
var onUpdateField = function onUpdateField(id, callback) {
  var element = document.getElementById(id); //recojo el elemento por id

  element.oninput = function (event) {
    return callback(event);
  }; //el event es cuando el usuario teclea
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"pages/transfer/trasnfer.api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.insertTransfer = exports.getAccountOptions = void 0;
...
var insertTransfer = function insertTransfer(transfer) {
  return _axios.default.post(urlTransfer, transfer) //post porque vamos a enviar desde la url con los datos del login
...
var yearValidator = function yearValidator(_ref3) {
  ...
  var succeeded = parseInt(value) >= new Date().getFullYear();
  return {
    succeeded: succeeded,
...
var validationSchema = {
  field: {
    ...
    iban: [{
      ...
      customArgs: {
        pattern: /^[A-Za-z]{2}\d{2}\s?(\d{4}\s?){4}\d{4}$/
      }
    }],
    name: [{
      validator: _fonk.Validators.required,
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","./transfer.custom.validators":"pages/transfer/transfer.custom.validators.js","@lemoncode/fonk-later-date-validator":"../node_modules/@lemoncode/fonk-later-date-validator/dist/@lemoncode/fonk-later-date-validator.esm.js"}],"pages/transfer/trasnfer.js":[function(require,module,exports) {
"use strict";
...
var _trasnfer = require("./trasnfer.api");
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _transfer2.formValidation.validateField('notes', transfer.notes).then(function (result) {
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  _transfer2.formValidation.validateForm(transfer).then(function (result) {
    ...
    if (result.succeeded) {
      (0, _trasnfer.insertTransfer)(transfer).then(function () {
        //history.back();
        console.log({
          transfer: transfer
        });
...
},{"../../common/helpers":"common/helpers/index.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","../../core/router":"core/router/index.js","./trasnfer.api":"pages/transfer/trasnfer.api.js","./transfer.validations":"pages/transfer/transfer.validations.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","pages/transfer/trasnfer.js"], null)
//# sourceMappingURL=/trasnfer.13edaea5.js.map