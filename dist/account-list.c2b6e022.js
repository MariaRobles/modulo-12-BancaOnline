...
var url = "".concat("http://localhost:3000/api", "/account-list"); //la variable de entorno está .env

var getAccountList = function getAccountList() {
  return (//esto nos trae todos los datos de la api TODOS
...
//para cuando se actualice un campo
//para navegar por el app
...
(0, _accountList.getAccountList)().then(function (accountList) {
  //me trae una promesa desde la api, así que va con then( => {.....})
  console.log({
    accountList: accountList
  }); //entre {} porque es un objeto

  var viewModelAccountList = (0, _accountList3.mapAccountListFromApiToViewModel)(accountList); //le aplico los cambios

  (0, _accountList2.addAccountRows)(viewModelAccountList); //función del helper para rellenar le pasamos los datos ya cambiados

  viewModelAccountList.forEach(function (account) {
    //por cada cuenta
    (0, _helpers.onUpdateField)("select-".concat(account.id), function (event) {
      //actualizo el valor pasándole el id
      var route = event.target.value; //con el evento que sería ponerle el valor 

      _router.history.push(route); //y se lo meto a history
